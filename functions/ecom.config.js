...
const app = {
  ...
  admin_settings: {
    ...
    link_products: {
      schema: {
        title: 'Sincronizar anuncios existentes no Mercado Livre.',
        description: 'Sincronizar anuncios já existentes no Mercado Livre aos produtos Ecom',
        type: 'array',
        maxItems: 200,
        items: {
          type: 'object',
          properties: {
            ...
            ml_product_id: {
              title: 'ID do produto no Mercado Livre',
              type: 'string'
            }
          },
          allows_balance_update: {
